...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)
   {
        ...
        echo ' alert("Sorry! Negative values are not accepted")';  // showing an alert box.
        echo '</script>';
    }
    ...
    // constraint to check zero values
         ...
         echo "<script type='text/javascript'>";
         echo "alert('Input amount should be greater than 0')";
         echo "</script>";
     }
                ...
                if($query){
                     echo "<script> alert('Transaction Carried Successfully');
...
<body style="background-color : white ">
 <header>
	...
	<div class="container">
        <br>
        <br>
        <h2 class="text-center pt-4" style="color : black;">Ongoing Transaction</h2>
            <?php
                include 'configurephp.php';
                $sid=$_GET['id'];
        ...
        <br>
        <br>
            <label style="color : black;"><b>Specify Amount:</b></label>
            <input type="number" class="form-control" name="amount" required>   
            <br>
                <div class="text-center" >
            <button class="btn mt-3" name="submit" type="submit" id="myBtn" style="background-color : aqua;">Transfer Now</button>
            </div>
        </form>
    </div>
